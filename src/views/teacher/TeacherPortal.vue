  ...
  <div class="teacher-portal-container">
        ...
        <el-card shadow="hover" class="today-schedule-card">
          <template #header>
            <div class="card-header">
              ...
              <el-button type="primary" text @click="handleNavigate('/teacher/schedule')">
                查看完整课表
              </el-button>
            </div>
          </template>
    ...
    <el-row :gutter="20" class="quick-actions">
      <el-col :xs="12" :sm="8" :md="6">
        <el-card shadow="hover" class="action-card" @click="handleNavigate('/teacher/schedule')">
      ...
      <el-col :xs="12" :sm="8" :md="6">
        <el-card shadow="hover" class="action-card" @click="handleNavigate('/teacher/lesson-records')">
          <div class="action-content">
      ...
      <el-col :xs="12" :sm="8" :md="6">
        <el-card shadow="hover" class="action-card" @click="handleNavigate('/teacher/teaching-data')">
          <div class="action-content">
      ...
      <el-col :xs="12" :sm="8" :md="6">
        <el-card shadow="hover" class="action-card" @click="handleNavigate('/teacher/approval')">
          <div class="action-content">
...
const handleRecordLesson = (lesson: any) => {
  ...
  router.push('/teacher/lesson-records?action=add')
}
